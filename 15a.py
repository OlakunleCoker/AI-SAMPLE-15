...
class Ui_MainWindow(object):
    ...
    def trainingFunction(self):
        ...
        training_set = train_datagen.flow_from_directory('C:/Users/OWNER/Desktop/sample15/train',
                                                         target_size = (128, 128),
                                                         batch_size = 8,
        ...
        test_set = test_datagen.flow_from_directory('C:/Users/OWNER/Desktop/sample15/test',
                                                    target_size = (128, 128),
                                                    batch_size = 8,
                                                    class_mode = 'categorical')
